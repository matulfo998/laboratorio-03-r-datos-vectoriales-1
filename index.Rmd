...
ggplot(centro_america, aes(x=reorder(name_long, -lifeExp), y=lifeExp)) +
  ggtitle("Expectiva de Vida en Centroamerica por País") +
  xlab("Países") + 
...
```{r}
plot(centro_america["lifeExp"], main="Expectativa de Vida en Centroamerica por País")
```
...
```{r}
centroamerica_muestra <- centro_america[centro_america$lifeExp>=74,]
plot(centroamerica_muestra["lifeExp"], main="Países de CA con Esperanza de Vida Mayor o Igual a 74 años")
```